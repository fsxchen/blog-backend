...
from book.apiview import BookBaseInfoListViewset, BookDetailInfoListViewset, BookNoteBaseInfoListViewset, \
    BookNoteDetailInfoListViewset
...
from apps.user.apiview import WxLoginView
...
urlpatterns = [
    ...
    url(r'api/auth/wxlogin$', WxLoginView.as_view()),
    # 文档
