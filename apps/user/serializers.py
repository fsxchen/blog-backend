...
from user.models import GuestProfile, EmailVerifyRecord
...
class WxLoginSerializer(serializers.Serializer):
    code = serializers.CharField(max_length=32, help_text="wx.logon返回的code")
    encrypteddata = serializers.CharField(max_length=2500, help_text="getuserinfo")
    iv = serializers.CharField(max_length=128, help_text="iv")
