...
class WxUserProfile(models.Model):
    "微信信息"
    nickname = models.CharField('微信昵称', max_length=100)
    openid = models.CharField('用户标识', max_length=100, default='', unique=True)
    ...
    avatar_url = models.URLField(max_length=256, default='')
    wx_register_date = models.DateTimeField(default=datetime.now, verbose_name='注册时间')
    user = models.OneToOneField(UserProfile, on_delete=models.CASCADE, related_name="wx_profile", null=True)
